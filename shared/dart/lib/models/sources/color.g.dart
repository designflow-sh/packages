...
_$VariableReferenceImpl _$$VariableReferenceImplFromJson(
        Map<String, dynamic> json) =>
    _$VariableReferenceImpl(
      json['variableID'] as String,
      $type: json['runtimeType'] as String?,
    );

Map<String, dynamic> _$$VariableReferenceImplToJson(
        _$VariableReferenceImpl instance) =>
    <String, dynamic>{
